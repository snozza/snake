...
var c_22448 = (a[i]);
if(cljs.core.truth_((c_22448["cljsIsDirty"]))){
(c_22448["forceUpdate"])();
} else {
}
...
var G__22452 = c;
var G__22452__$1 = (((G__22452 == null))?null:(G__22452["props"]));
if((G__22452__$1 == null)){
return null;
} else {
return (G__22452__$1["argv"]);
}
});
...
var G__22454_22455 = (c["cljsRatom"]);
if((G__22454_22455 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__22454_22455);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1466146180689